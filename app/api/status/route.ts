...
// Mirrors LOOKUP_CONCURRENCY in /api/circle/members. Auth0 Management API
// dev tenants throttle around 2 req/sec sustained.
...
// Same logic as /api/circle/members; kept for legacy/external consumers.
